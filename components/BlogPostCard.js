...
export default function BlogPostCard({ title, slug, index, date }) {
	return (
		...
		<a className="w-full" aria-label={title}>
			<div className="w-full border-b border-gray-700 dark:border-gray-700 py-3 transform hover:scale-[1.01] transition-all">
			<div className="flex flex-col sm:flex-row justify-between sm:items-center">
				<div className="flex items-center">
				<div className="text-gray-700 dark:text-gray-200 text-left mr-6">{index}</div>

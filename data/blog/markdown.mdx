...
draft: false
summary: 'This blog uses Markdown, with GitHubs flavor. To parse the markdown it uses some remark and rehype (Unified) packages like next-mdx-remote and next-prism.'
---

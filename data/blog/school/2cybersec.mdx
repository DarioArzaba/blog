...
**Security** is freedom from or resilience against potential harm caused by others. **Cybersecurity**, also known as information technology security or electronic information security, is the practice of defending computers and electronic systems from malicious attacks. The most common attack for unauthorized access being social engineering.

## Types of Cybersecurity ##

* Application: Prevent data and code used by a business from being stolen using penetration testing and encryption.
* Information: Prevent physical and digital data from unauthorized access and manipulation, on-site and on remote systems.
* Infrastructure: Implementing access control to facilities such as the electrical grid and data centers.
* Network security: Secure internal computer networks against unauthorized access using remote access management and 2FA.
* Users Education: Teach every employee and customer to recognize and avoid malware and phishing.

## Importance ##

Cybersecurity protects data including sensitive data, personally identifiable information (PII), health information (PHI), intellectual property, governmental systems and industry systems from theft and damage, were attackers are no longer hacking enthusiasts but organized crime groups.

> In 2021 3.5 million cybersecurity positions went unfulfilled globally.

A malware attack creates on average 2.4 million dollars and 50 days of operational disruption in damages, the most common one being a **ransomware** attack with an average cost of 1.85 million dollars (2021) mainly from downtime, lost orders and operational costs with the ransom representing only a tenth of the losses. The number of organizations that pay the ransom has also increased to 32% (2021) even if less than 10% recover any data.

The **Mexican Law** for Cybersecurity is included in 211 of the Codigo Penal Federal enforced by the national guard cybercrime unit. Sadly Mexico is the largest producer of CP content as well while theft, infrastructure damages and financial attacks remain common.

## Areas ##

The human, organizational and regulatory areas of cybersecurity include risk management, governance, human factor, privacy, and laws. The threat defense area includes malware protection, adversarial behaviors, digital forensics, security operations and incident management.

* Systems Security: Operating Systems, virtualization, cryptography, AAA, hardware security, network security and web security.
* Software Security: Software security, lifecycle, updates and web security.
* Infrastructure Security: Cyberphysical security, physical layer, telecoms security, hardware security and network security.

## Assets ##

Assets are something of value to a person, business or organization. IT assets add value to the organization and include:
...
Confidentiality, Integrity and Availability (CIA) are the pillars of modern cybersecurity and good security systems. 

* Confidentiality: Component associated with secrecy and encryption, data must be available only to authorized agents. It ensures that confidential information isn't compromised by other parties, that data can't be accessed by people that doesn't require it, that information is organized in such a way that it is released in a need to know basis. It considers hashes (one-way functions) to be the most common way of encryption and social engineering to be the most common way of breaching them.
* Integrity: Data integrity refers to the certainty that data won't be tampered or degraded during or after submission. It ensures that data is kept secure from unauthorized modification, even if unintentional, during upload, transmission or storage in a database.
* Availability: Information is readily available to authorized users, done by having properly functioning systems, security controls and good communication channels. The resources used in availability depend on how critical the system is, some systems such as power generation, medical equipment, safety devices and military equipment have extreme availability requirements against cyber threats, power outages, hardware failures and other adverse events.

## Aspects ##

The pillars are considered though three fundamental security aspects or levels:

* Process level: Management systems, governance, policies, 3rd party management (mission, vision, responsibilities, roles and politics that define the way that people operate).
* Data-Tech level: IT, OT, Personal Data, Operational Data (assets used to help people achieve their process objectives).
* People level: Training, awareness, skills, qualifications, authorization and physical security (agents that operate the security mechanisms, their actions impact the security of the organization).
...
* Authenticity: Property of data or systems of being genuine, verifiable and trusted while in transmission or in storage.
* Nonrepudiation: Property of data or systems that prevents another agent of denying the authenticity of the data.
* Privacy: Property of data or systems that prevents an individual to control, store or influence data created by others.

> Cybersecurity is the prevention of damage to, protection of and restoration of computers, electronic systems and information contained therein to ensure availability, integrity, confidentiality, authentication and nonrepudiation. It is a subset of information technology security using CIA for asset protection of cyber and physical systems. Today both cybersecurity and information security are used interchangeably.

# Threats #

Cyber **threat intelligence** is the currently known information about threats and threat actors, sources include open source malware, social media, human reports, technical documents and deep web forums.

* Threat: Active entity that can cause damage to a person, system or organization, also called adversarial agent as they oppose the business objectives. It can be natural or human, human threats can be intentional or unintentional, intentional human threats can be random or targeted. They are classified through their **impact** (potential damage in terms of monetary, operational and asset costs) and through their **risk** (probability of a threat of exploiting a vulnerability and causing damages).
* Vulnerability: Flaw or weakness in people, processes or technology that facilitate threats resulting in damages or losses. An **exploit** is computer system attack that takes advantage of a particular vulnerability in the operating system, application or any software, generally originating from an intentional human threat.
* Threat Control: Actions, mechanisms, devices or techniques used to mitigate, remove or reduce vulnerabilities. They are classified into detection, prevention, recover, mitigation, transfer and deterrence.

## Actors ##

Cyber threat actors are states, groups or individuals with malicious intent aimed at taking advantage of vulnerabilities, low security awareness and technological developments to gain unauthorized access affecting data, devices, systems and networks, for example:
...
Malware is a generic term used to refer to any malicious software designed to harm or exploit programmable devices, systems or networks. Malware infects a computer and changes how it functions, destroys data or spies on the user, it can spread from one device to another or remain in place only impacting its host.

* Infection routine: Mechanism used by malware to get into the target system. It can be installed alone as standalone program in the memory, system process, startup process or in the MBR, it can also be installed with the help of another program by prepending, appending, cavities, insertion, destruction or company.
* Payload: Effects of the malware on the computer. It can modify, steal, monitor or destroy information; it can cover its tracks using encryption, polymorphism or packaging; it can persist by installing backdoors (meterpreter, reverse shell, ssh, CC Clients); it can control what the computer does and it can encrypt information and ask for a ransom.
* Propagation routine: Mechanism used by malware to propagate into another target. Vectors include physical media (usb autorun), downloads (piracy), documents (office, acrobat), website scripts (compromised site), email (attachments), network (port scanner).

### Types ###

* Phishing: Email or website disguised as originating from a trusted source with the intent of stealing sensitive information, they combine technology with social engineering.
* Spear Phishing: Targeted phishing attack custom made for a particular target, using email spoofing they can appear to come from an email that the user personally trusts.
...
* Virus: Usually infecting trough email attachments, they hold a payload that performs a malicious action once the file is opened by the user. NATAS in an example of a a virus that infects random software and one of the first to be able to replicate.
* Trojans: Malware that camouflages itself a harmless or known application but once it's up and running they can steal data, crash the device, spy or launch an attack.
* Backdoor: Point of entry into a system that bypasses authentication measures, encryption or other intrusion detection. Using a backdoor the attacker can steal information, install further malware or control system processes, legitimate backdoors are often used by software for troubleshooting, updates and maintenance.
* Bots and Botnets: A bot is an internet connected device that can be remotely controlled to perform a malicious attack without the owner's awareness. A botnet is an array of bots that perform the perform a malicious attack multiple times.
* Distributed Denial of Service DOS or DDOS: Attack designed to overwhelm the resources of a system so that it is unable to reply to legitimate service requests, it is initiated by a botnet to prevent the victim of providing its service to legitimate users.
* Rootkit: Provides a remote actor with privileged user access and therefore full control of the device.
* Scareware: Scares users into thinking their system has been compromised in order to purchase a fake solution.
* Worms: Designed to copy themselves from device to device as quickly as posible without requiring any user interaction.
* Spyware: Designed to capture and transmit personal information and browsing habits of the user by monitoring any form of communication.
* Adware: Installed with harmless programs to create unwanted advertisements and pop up windows.
* Man in the Middle (MITM): Attack or breach designed to eavesdrop on the data being sent between two people, networks or devices. The attacker positions themselves in the middle of their communication effectively spying on the interaction.

Defenses against malware include antivirus software, signatures, heuristics, security suites, sandboxing, threat intelligence, asset configuration, digital hygiene, email protection, firewalls and proxis.

## Attacks ##

Attacks can be classified into targeted or un-targeted:

* Un-targeted: They include phishing (emails asking for sensitive information or visiting a fake website), ransomware (dissemination of disk encryption extortion malware), scanning (trying an exploit on large portions of the internet at random) or water holing (fake or compromised website that exploits visiting users).
* Targeted: They include spear phishing (custom emails that contain malicious attachments or links), botnets (delivering a DDOS attack) or subverting the supply chain (disabling equipment or software being used by a particular organization).

### Stages ###

Any attack, particularly if carried out by a persistent adversary and regardless if it is targeted or un-targeted, has a number of common stages. The objective of the attacker is to systematically prove the system defenses to find exploitable vulnerabilities, understanding this stages help to create more effective defenses.

* Survey: Investigate and analyze any available information about the target such as open source, social media, domain name services, commodity toolkits and network scanning tools in order to understand the system, defenses and personnel for the identification of any potential technical, procedural or physical vulnerabilities.
* Delivery: Attackers get into the most favorable position by creating the optimal conditions to exploit the identified vulnerability, for example they can attempt to access an organization's online services, send emails containing malicious attachments, giving away infected USB sticks or creating a targeted phishing site.
* Breach: Exploiting the vulnerability to gain some form of unauthorized access, the impact will depend on the nature of the vulnerability and the exploitation method and it can range from making changes to the system's operation, gaining access to online accounts or achieving full control of the device.
* Affect: The attacker uses the breach to explore the system further (automated scanning tools), expand their access and establish a persistent presence (consolidation) in order to increase the probability of achieving their ultimate goal. In this stage the attacker takes great care not to trigger or temporarily disable any monitoring processes in the system. 

# Cryptology #

* Cryptography: Divided into protocols, asymmetric ciphers and symmetric ciphers.
	* Ancient cryptography starts in Egypt with letter-based encryption (Caesar cipher).
	* Symmetric ciphers are divided into stream ciphers and block ciphers (all encryption schemes until 1976).
	* Asymmetric ciphers start in 1976 with public-key cryptography proposed by Diffie, Hellman and Merkle.
	* Hybrid schemes are in use today with symmetric for encryption-authentication and asymmetric for key exchange and signatures.
* Cryptoanalysis.

## Symmetric Cryptography ##

Also known as private-key, single-key or secret-key, they prevent one to one communication from being intercepted by a middle man using an unsecure channel, the objective is data encryption so that only authorized parties understand the message.

The message in plaintext $x$ is communicated through an encryption function $e$ using a random key generator $K$ through a secure channel that generates a ciphertext $y$. The text is retrieved with a decryption function $d$, therefore the attacker needs to intercept the ciphertext $y$ as well as the unique key $K$ to obtain the message.

$$
\begin{gathered}
	\text{Encryption Equation}\\
	y = eK(x)\\
	\text{Decryption Equation}\\
	x = dK(y)\\
\end{gathered}
$$

Encryption and decryption are inverse operation when using the same key on both sides.
...
With this system the security of the communication is reduce to the secure transmission and storage of a single key.

## Cryptoanalysis ##

There is no mathematical proof of security for any practical cipher, therefore Kerckhoff's principle is paramount in modern cryptography:

> A cryptosystem should be secure even if the attacker knows every single detail about the system, with the exception of the secret key. 

In practice this means to only use well known and tested ciphers, it may be tempting to use a secret cipher however history has shown that secret ciphers tend to be easily broken with enough reverse engineering since given enough time they can be better understood from external parties than the creators themselves.

Cryptoanalysis includes: classical attacks, mathematical analysis, brute-force approaches, social engineering and implementation attacks.

### Brute-Force ###

Also known as exhaustive key search against symmetric ciphers, it treats the cipher as black box requiring at least 1 plaintext and ciphertext pair $(x_0, y_0)$ to check all possible keys until the condition $dK(y_0) = x_0$ is fulfilled.
...
Let k, x, y parte de 0,1,2,3,4...25
...
Let k, x, yparte de 0,1,2,3,4...25
...
Governance describes the policies and processes that determine how organizations detect, prevent and respond to cyber incidents, in most cases there is a distinction between management and governance. Governance is characterized by strategic planning while management deals with day-to-day operations regarding security.

The cybersecurity governance cycle includes:

1. Measurement and reporting: Robust systems for measuring and reporting compliance and continuous improvements of the programs.
2. Vision and strategy alignment: The organization vision guides the decision-making process and is aligned with the overall security strategy.
3. Security roles and responsibilities: The roles are well defined and integrated within the organization activities.
4. Risk management: Holistic approach that involves a deep understanding of the threats that the organization faces.
5. Cybersecurity steering group: Allocation and oversight of cybersecurity resources through forums and programs.
6. Cybersecurity program: Organization's unique governance defined by the the policies and processes related to cybersecurity.

The steps needed to build a cybersecurity governance plan are:

1. Create a strong cybersecurity culture with a strategy that promotes a cultural shift.
2. Create roles and responsibilities according to the company's hierarchy, from top to bottom.
3. Create a holistic risk management program using a framework that identifies, analyzes, evaluates and manages risks.
4. Translate the strategy and the company vision into practical actions that create security collaboration.
5. Consider that the program and the organization's resilience should be measured, tracked, assessed and reported constantly.

The security areas that a governance plan must include are:
...
1. Los dos algoritmos se ponen de acuerdo en un numero p (primo) y un número g (g menor a p)
...
3. Elegimos e=5, donde 5 menor a 91, y mcd(5, 72)=1

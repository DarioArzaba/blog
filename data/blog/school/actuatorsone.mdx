...
The coil used in a magnetic circuit may be thought as an inductance, here inductance is defined as the *Magnetic Flux Linkage* $\lambda$ per Ampere of current:
...
\begin{gathered}
	...
	\mu_c = (\mu_r)(\mu_0) = (3000)((1.25663 \times 10^{-6}) = 0.0037699111\\
	\Re_c = \frac{l_c}{(\mu_c)(A_c)} = \frac{0.5}{(0.0037699111)(0.0015)} = 88419 \, \text{At}{wb}\\
	\Re_g = \frac{l_g}{(\mu_0)(A_g)} = \frac{0.001}{(1.25663 \times 10^{-6})(0.0015)} = 530516 \, \text{At}{wb}\\
...
\begin{gathered}
	...
	A = \pi(r_A)^2 = \pi(\frac{25-20}{2})^2 = 1.963495408 \times 10^{-3}\\
	\Phi = (B)(A) = (1.225)(1.963495408 \times 10^{-3}) = 0.002405 \, \text{wb}\\

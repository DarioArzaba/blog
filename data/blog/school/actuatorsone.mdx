...
4. [DC Machines](#dc-machines)
	1. [Electromagnetic Energy Conversion](#electromagnetic-conversion)
	2. [Construction of DC Machines](#machine-construction)
	3. [Armature Windings and Voltage](#armature-voltage)
	4. [Developed Torque](#developed-torque)
	5. [Generator Classification](#generator-classification)
	6. [Separately Excited Generator](#separately-excited-generator)
	7. [Shunt (self-excited) Generator](#self-excited-generator)
	8. [Compound Machines and Series Generator](#compound-machines)
	9. [Motors, Shunt Motor, Series Motor](#direct-current-motors)
5. [Induction Machines](#induction-machines)
	1. [Three Phase Connections](#three-phase-connections)
	2. [Rotating Magnetic Field](#rotating-magnetic-field)
	3. [Polyphase Induction Machine](#polyphase-induction-machine)
	4. [Equivalent Circuit Model](#equivalent-circuit-model)
	5. [Performance Characteristics](#performance-characteristics)
6. [Hydraulic Actuators](#hydraulic-actuators)
	1. [Fluid Fundamentals](#fluid-fundamentals)
	2. [Flow in Orifices](#flow-in-orifices)
	3. [Valves and Hydraulic Control](#valves-and-hydraulic-control)
	4. [General Analysis of Valves](#valve-analysis)
	5. Pumps and Motors

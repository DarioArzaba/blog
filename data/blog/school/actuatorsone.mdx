...
For example a manual valve. Here the expected water flow is the input, the valve position is the element of control, the water level in a tank can be the element of correction, the process is the water filling the tank and finally the controlled variable output is maintaining the tank full of water. 
...
Examples of mechanic systems that use actuators are robotic arms, car wipers, automatic transmissions or car valve bodies.

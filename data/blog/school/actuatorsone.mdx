...
\begin{gathered}
	...
	\Phi = \frac{(N)(i)}{\Re} = \frac{(N)(i)}{\Re_c + \Re_c}\\
	(N)(i) = (H_c)(l_c) + (H_g)(l_g)\\ 
...
$$
\begin{gathered}
	(N)(i) = (H_c)(l_c) + (H_g)(l_g) \implies (N)(i) = (H_c)(l_c) + (H_g)(l_g)(2)\\
	\text{From the graph: } 0.8 \, \text{T} =  510 \, \text{At/m}\\
	F_c = (H_c)(l_c) = (510)(0.36) = 184 \, \text{At}\\
	B = (\mu)(H) \implies H_g = \frac{B_g}{\mu_0}\\
	(H_g)(l_g)(2) = \frac{0.8}{1.25663 \times 10^{-6}} (0.0015)(2) = 1909.8 \approx 1910 \, \text{At}\\
	(N)(i) = 184 + 1910 \implies i = \frac{2094}{500} = 4.18\,\text{A}\\
	\therefore i = 4.18\,\text{A}\\\\
	B_c = (\mu_c)(H_c) \implies \mu_c = \frac{B_c}{H_c} = \frac{0.8}{500} = 0.00157\\

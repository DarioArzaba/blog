...
A disadvantage of the air gap is that it introduces a higher $F$ requirement to maintain the same flux density on the core's material and in the air, however it also allows for the core to be completely saturated in a safely manner since the air will remain unsaturated. To account for the air gap we introduce an additional reluctance to the magnetic circuit equivalent.

...
* The electronic system must be based on Op-Amps and converters, it must be innovative, feasable, and with a high possibility of becoming a venture. 
* In the design stage you must quantitatively demostrate the need to be solved, adressing constraints, costs, competition etc. 
...
* Deliverable 3: Requirements and restrictions. Restrictions placed on the system. Risk factors that threathen the project.

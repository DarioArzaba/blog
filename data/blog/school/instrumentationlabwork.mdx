...
The objective is to know the basic characteristics of operational amplifiers and know some of the circuit configurations that use Op Amps. The procedure involves using common configuration of Inverse Amplifiers, Non Inverting Amplifiers, Inverting Adder Amplifiers and Differential Amplifiers while adjusting the resistances in their configurations to control the gain that results in the final voltage output.

Op-Amps are high gain, direct current, coupled electronic amplifiers with two inputs and one output, in other words they are voltage dependent voltage sources. Their voltage gain of its voltage output will depend on the voltage supplied and the voltage on the Non Inverting (Vp) and Inverting (Vn) input signals. 
...
https://experiencia21.tec.mx/courses/189344/assignments/5310036?module_item_id=9304536

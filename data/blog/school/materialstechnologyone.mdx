...
Temperature plays an important role in the behavior of polymeric chains, at high temperature they act like liquids with the chains moving easily, at medium temperature they form solid amorphous structures (chains move only under pressure) or crystalline structures (chains form rigid crystal regions), at low temperature they act as glass where it is only possible to move local segments of the polymer chains.

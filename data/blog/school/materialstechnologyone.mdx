...
\begin{gathered}
	\text{Esfera cobre}\\
	r = 12.51 \times 10^{-8} \,\text{cm} = 1.25 \, \text{nm}\\
	a = 0.3615\\
...
\begin{gathered}
	\text{Esfera niquel}\\
	r = 2.9 \times 10^{-6} \,\text{cm} = 29 \, \text{nm}\\
	a = 0.356\\
	v = \frac{4 \pi (29 \, \text{nm})^3}{3} = 102160.4 \, \text{nm}^3\\
	v_{cu} = a^3 = (0.356)^3 = 0.04511 \, \text{nm}^3\\
	n_{cu} = \frac{v}{v_{cu}} = \frac{102160.4 \, \text{nm}^3}{0.04511 \, \text{nm}^3} = 2264695.19 \, \text{cu}\\
	n = (\frac{4}{\text{cu}})(2264695.19 \, \text{cu}) = 9058780.76 \, \text{atomos}
\end{gathered}
$$
...
\begin{gathered}
	\text{Esfera niquel}\\
	r = 1.107 \, \text{nm} \land \rho = 0.92 \, \text{Mg/m3}\\
	h_{}
	a = 0.356\\
	v = \frac{4 \pi (29 \, \text{nm})^3}{3} = 102160.4 \, \text{nm}^3\\
	v_{cu} = a^3 = (0.356)^3 = 0.04511 \, \text{nm}^3\\
	n_{cu} = \frac{v}{v_{cu}} = \frac{8.18 \, \text{nm}^3}{0.047 \, \text{nm}^3} = 2264695.19 \, \text{cu}\\
	n = (\frac{4}{\text{cu}})(174.04 \, \text{cu}) = 9058780.76 \, \text{atomos}
\end{gathered}
$$

...
\begin{gathered}
	...
	(R_2)((\cos(\theta_2)) + \sin(\theta_2) \, j) + (R_e)((\cos(\theta_e)) + \sin(\theta_e) \, j) = (R_1)((\cos(\theta_1)) + \sin(\theta_1) \, j)\\
	...
	(R_2)^2(\cos^2(\theta_2)) - ((2)(R_2)(R_1)(\cos(\theta_2))) + (R_2)^2(\sin^2(\theta_2)) + (R_1)^2 = (R_e)^2(\cos^2(\theta_e)) + (R_e)^2(\sin^2(\theta_e))\\
	(R_2)^2((\cos^2(\theta_2)) + (\sin^2(\theta_2))) - ((2)(R_2)(R_1)(\cos(\theta_2))) + (R_1)^2 = (R_e)^2((\cos^2(\theta_e)) + (\sin^2(\theta_e)))\\

...
This is an overview of the knowledge needed for simulating mechanisms, machines, intruments and actuators. Understand the mechanisms used in machines (wheel, rack, joints, gears, cams, bars etc).  Requires knowledge in statics and dynamics. 

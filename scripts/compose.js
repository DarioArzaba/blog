/* 
Script to fill out a new post quickly.
1. Get the authors of the post.
2. Get the layout for the post components
3. Get the post metadata (FrontMatter)
	1. If there were authors include them in the metadata
4. Define the prompt messages you see when you fill it
5. Also handle possible errors if it fails
*/
